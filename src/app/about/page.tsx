            ...
            <div>
              ...
              <div className="space-y-4 text-gray-700 text-sm leading-relaxed">
                <p>
                  ...
                  who builds technology that actually matters (or at least tries
                  to).
                </p>
                <p>
                  My journey started in Physics and Biomedical Engineering, but
                  I quickly realized I craved something faster-paced. After
                  univeristy, I moved to San Francisco, slept on my
                  friend&apos;s coach for two weeks until I found my first job,
                  and I loved fast-pace market software engineering and San
                  Francisco offered.
                </p>
                <p>
                  ...
                  crafting HTML pages for my digital companion, and honestly, it
                  was love at first{" "}
                ...
                <p>
                  ...
                  me in my kitchen—which looks more like a gadget graveyard than
                  a place to cook. I&apos;m passionate about culinary
                  experimentation and fermentation, though I should mention
                  I&apos;ve sacrificed more than a few jars to the fermentation
                  gods (my neighbors can attest to the occasional explosive
                  sound effects).
                </p>{" "}
                <p>
                  I&apos;m also a travel enthusiast with 35+ countries under my
                  belt, always hunting for new flavors, perspectives, and the
                  random friends I make in the most unexpected places.
                </p>
                <p>
                  Currently, I&apos;m diving deep into AI research, specifically
                  exploring how to secure Agent-to-Agent communication.
                </p>
                <p>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-700 text-xs leading-relaxed">
                    I once debugged a critical production issue while hiking in
                    the Swiss Alps! Sometimes the best solutions come when you
