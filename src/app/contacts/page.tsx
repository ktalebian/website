  ...
  return (
    <div className="bg-gray-100 min-h-screen flex flex-col relative overflow-hidden">
      ...
      <div className="relative z-20 flex items-center justify-between px-6 pt-6 pb-4">
        ...
        <h1 className="text-black font-semibold text-lg">Contact Info</h1>
        ...
        <div className="max-w-lg mx-auto">
          <div className="bg-white/60 backdrop-blur-3xl rounded-2xl border border-gray-300/50 shadow-lg overflow-hidden">
            ...
            <div className="p-6 text-center border-b border-gray-300/30">
              ...
              <h2 className="text-black font-semibold text-xl">Kousha Talebian</h2>
              <p className="text-gray-600 text-sm mt-1">Principal Engineer at Twilio, Inc</p>
            </div>
            ...
            <div className="divide-y divide-gray-300/30">
              ...
              <div className="p-4 hover:bg-white/30 transition-colors cursor-pointer">
                ...
                >
                  ...
                  <div className="flex-1">
                    <p className="text-gray-600 text-xs uppercase tracking-wide">LinkedIn</p>
                    <p className="text-black font-medium">linkedin.com/in/koushatalebian</p>
                  </div>
              ...
              <div className="p-4 hover:bg-white/30 transition-colors cursor-pointer">
                ...
                >
                  ...
                  <div className="flex-1">
                    <p className="text-gray-600 text-xs uppercase tracking-wide">GitHub</p>
